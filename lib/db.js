...
async function createArticle(data) {
  const result = await query(
    `INSERT INTO articles (titre_interne, corps, accroche_a, accroche_b, hashtags, source_news_titre, source_news_url, source_news_source, ia_provider, ia_model, generation_type, custom_subject, statut, image_url, image_photographer, image_photographer_url)
