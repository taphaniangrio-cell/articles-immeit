...
async function fetchRSS(url) {
  ...
  try {
    const response = await fetch(url, {
      headers: { 'User-Agent': 'Mozilla/5.0 (compatible; IMMEIT-Articles/1.0; +https://github.com/taphaniangrio-cell/immeit-hub)' },
...
async function fetchNews() {
  ...
  const globalTimeout = CONSTANTS.RSS_GLOBAL_TIMEOUT;
